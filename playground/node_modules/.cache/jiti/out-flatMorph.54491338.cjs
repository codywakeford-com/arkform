"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.flatMorph = void 0;var _arrays = require("./arrays.js");
const flatMorph = (o, flatMapEntry) => {
  ...
  for (const [i, entry] of Object.entries(o).entries()) {
    ...
    for (const [k, v] of flattenedEntries) {
      if (typeof k === "object")
      result[k.group] = (0, _arrays.append)(result[k.group], v);else

      result[k] = v;
    }
  }
  return outputShouldBeArray ? Object.values(result) : result;
};exports.flatMorph = flatMorph; /* v9-645520885180d14a */
