...
var _safeGet = _interopRequireDefault(require("./_safeGet.js"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function baseMerge(object, source, srcIndex, customizer, stack) {
  ...
  (0, _baseFor.default)(source, function (srcValue, key) {
    ...
    } else
    {
      ...
      customizer((0, _safeGet.default)(object, key), srcValue, key + '', object, source, stack) :
      undefined;
