...
export {}
declare global {
  const $tasks: typeof import('../../../src/runtime/arkfire/$tasks')['$tasks']
...
declare global {
  ...
  // @ts-ignore
  export type { QueueTask } from '../../../src/runtime/arkfire/$tasks'
  import('../../../src/runtime/arkfire/$tasks')
}
// for vue template auto import
import { UnwrapRef } from 'vue'
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly $tasks: UnwrapRef<typeof import('../../../src/runtime/arkfire/$tasks')['$tasks']>
