...
var differenceWith = (0, _baseRest.default)(function (array, values) {
  ...
  (0, _baseDifference.default)(array, (0, _baseFlatten.default)(values, 1, _isArrayLikeObject.default, true), undefined, comparator) :
  [];
});var _default = exports.default =

differenceWith; /* v9-2e7e8ca43f3f5f98 */
