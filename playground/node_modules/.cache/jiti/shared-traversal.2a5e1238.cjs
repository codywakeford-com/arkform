"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.traverseKey = exports.Traversal = void 0;var _util = require("@ark/util");
...
class Traversal {
   ...
   */
  errors = new _errors.ArkErrors(this);
  /**
  ...
  queueMorphs(morphs) {
    const input = {
      path: new _util.ReadonlyPath(...this.path),
      morphs
    };
    if (this.currentBranch)
    this.currentBranch.queuedMorphs.push(input);else
  ...
  errorFromContext(errCtx) {
    const error = new _errors.ArkError(errCtx, this);
    if (this.currentBranch)
    this.currentBranch.error = error;else
...
ctx) => {
  ...
  ctx.path.pop();
  return result;
};exports.traverseKey = traverseKey; /* v9-d901102701a0c6c0 */
