...
var differenceBy = (0, _baseRest.default)(function (array, values) {
  ...
  (0, _baseDifference.default)(array, (0, _baseFlatten.default)(values, 1, _isArrayLikeObject.default, true), (0, _baseIteratee.default)(iteratee, 2)) :
  [];
});var _default = exports.default =

differenceBy; /* v9-00939447bff2d5e1 */
