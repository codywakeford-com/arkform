"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _baseIsEqual = _interopRequireDefault(require("./_baseIsEqual.js"));
...
function baseMatchesProperty(path, srcValue) {
  ...
  return function (object) {
    ...
    (0, _hasIn.default)(object, path) :
    (0, _baseIsEqual.default)(srcValue, objValue, COMPARE_PARTIAL_FLAG | COMPARE_UNORDERED_FLAG);
  };
}var _default = exports.default =

baseMatchesProperty; /* v9-76c9eaf9ad9df793 */
