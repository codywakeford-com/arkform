"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.writeJsonSyntaxErrorProblem = exports.uuid = exports.url = exports.tryParseDatePattern = exports.stringNumeric = exports.stringInteger = exports.stringDate = exports.string = exports.regexStringNode = exports.normalizedForms = exports.normalize = exports.json = exports.iso8601Matcher = exports.isLuhnValid = exports.ip = exports.creditCard = exports.capitalize = exports.NFKD = exports.NFKC = exports.NFD = exports.NFC = void 0;var _schema = require("@ark/schema");
...
const regexStringNode = (regex, description, jsonSchemaFormat) => {
  ...
  return (0, _schema.node)("intersection", schema);
};exports.regexStringNode = regexStringNode;
const stringIntegerRoot = regexStringNode(_util.wellFormedIntegerMatcher, "a well-formed integer string");
const stringInteger = exports.stringInteger = _scope.Scope.module({
  ...
  parse: (0, _schema.rootSchema)({
    ...
    declaredOut: _schema.intrinsic.integer
  })
}, {
  name: "string.integer"
});
const hex = regexStringNode(/^[\dA-Fa-f]+$/, "hex characters only");
const base64 = _scope.Scope.module({
...
const capitalize = exports.capitalize = _scope.Scope.module({
  root: (0, _schema.rootSchema)({
    in: "string",
...
exports.isLuhnValid = isLuhnValid;const creditCardMatcher = /^(?:4\d{12}(?:\d{3,6})?|5[1-5]\d{14}|(222[1-9]|22[3-9]\d|2[3-6]\d{2}|27[01]\d|2720)\d{12}|6(?:011|5\d\d)\d{12,15}|3[47]\d{13}|3(?:0[0-5]|[68]\d)\d{11}|(?:2131|1800|35\d{3})\d{11}|6[27]\d{14}|^(81\d{14,17}))$/;
const creditCard = exports.creditCard = (0, _schema.rootSchema)({
  domain: "string",
  pattern: {
...
const iso8601Matcher = exports.iso8601Matcher = /^([+-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-3])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))(T((([01]\d|2[0-3])((:?)[0-5]\d)?|24:?00)([,.]\d+(?!:))?)?(\17[0-5]\d([,.]\d+)?)?([Zz]|([+-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$/;
...
const tryParseDatePattern = (data, opts) => {
  ...
  return date;
  return writeFormattedExpected(opts.format);
};exports.tryParseDatePattern = tryParseDatePattern;
const isParsableDate = (s) => !Number.isNaN(new Date(s).valueOf());
const parsableDate = (0, _schema.rootSchema)({
  domain: "string",
  predicate: {
...
narrow((s, ctx) => {
  ...
  const out = _number.number.epoch(n);
  if (out instanceof _schema.ArkErrors) {
...
assertHasKind("intersection");
const epoch = _scope.Scope.module({
  root: epochRoot,
  parse: (0, _schema.rootSchema)({
    in: epochRoot,
    morphs: (s) => new Date(s),
    declaredOut: _schema.intrinsic.Date
  })
}, {
...
const stringDate = exports.stringDate = _scope.Scope.module({
  root: parsableDate,
  parse: (0, _schema.rootSchema)({
...
")(%[0-9a-zA-Z.]{1,})?$");
const ip = exports.ip = _scope.Scope.module({
...
};exports.writeJsonSyntaxErrorProblem = writeJsonSyntaxErrorProblem;
const jsonRoot = (0, _schema.rootSchema)({
...
const json = exports.json = _scope.Scope.module({
  ...
  parse: (0, _schema.rootSchema)({
    ...
    in: "string",
    morphs: parseJson,
    declaredOut: _schema.intrinsic.jsonObject
  })
}, {
  name: "string.json"
});
const preformattedLower = regexStringNode(/^[a-z]*$/, "only lowercase letters");
const lower = _scope.Scope.module({
  root: (0, _schema.rootSchema)({
    in: "string",
...
const normalizedForms = exports.normalizedForms = ["NFC", "NFD", "NFKC", "NFKD"];
const preformattedNodes = (0, _util.flatMorph)(normalizedForms, (i, form) => [
form,
(0, _schema.rootSchema)({
  domain: "string",
  predicate: (s) => s.normalize(form) === s,
  meta: `${form}-normalized unicode`
})]
);
const normalizeNodes = (0, _util.flatMorph)(normalizedForms, (i, form) => [
form,
(0, _schema.rootSchema)({
  in: "string",
...
const numericRoot = regexStringNode(_util.numericStringMatcher, "a well-formed numeric string");
const stringNumeric = exports.stringNumeric = _scope.Scope.module({
  root: numericRoot,
  parse: (0, _schema.rootSchema)({
    in: numericRoot,
    morphs: (s) => Number.parseFloat(s),
    declaredOut: _schema.intrinsic.number
  })
}, {
  name: "string.numeric"
});
const regexPatternDescription = "a regex pattern";
const regex = (0, _schema.rootSchema)({
  domain: "string",
  predicate: {
...
const preformattedTrim = regexStringNode(
  ...
  /^\S.*\S$|^\S?$/, "trimmed");
const trim = _scope.Scope.module({
  root: (0, _schema.rootSchema)({
    in: "string",
    morphs: (s) => s.trim(),
...
const upper = _scope.Scope.module({
  root: (0, _schema.rootSchema)({
    in: "string",
...
const urlRoot = (0, _schema.rootSchema)({
  domain: "string",
  predicate: {
    meta: "a URL string",
...
const url = exports.url = _scope.Scope.module({
  root: urlRoot,
  parse: (0, _schema.rootSchema)({
    declaredIn: urlRoot,
    in: "string",
...
const string = exports.string = _scope.Scope.module({
  root: _schema.intrinsic.string,
