"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _baseToString = _interopRequireDefault(require("./_baseToString.js"));
...
function truncate(string, options) {
  ...
  (0, _castSlice.default)(strSymbols, 0, end).join('') :
  string.slice(0, end);
