"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _castPath = _interopRequireDefault(require("./_castPath.js"));
...
function hasPath(object, path, hasFunc) {
  ...
  return !!length && (0, _isLength.default)(length) && (0, _isIndex.default)(key, length) && (
  (0, _isArray.default)(object) || (0, _isArguments.default)(object));
}var _default = exports.default =

hasPath; /* v9-fd48408096d61afe */
