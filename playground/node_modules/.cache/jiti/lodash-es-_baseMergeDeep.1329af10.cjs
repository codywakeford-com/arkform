"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _assignMergeValue = _interopRequireDefault(require("./_assignMergeValue.js"));
...
var _toPlainObject = _interopRequireDefault(require("./toPlainObject.js"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    ...
    if (isArr || isBuff || isTyped) {
      ...
      if ((0, _isArrayLikeObject.default)(objValue)) {
    ...
    if ((0, _isPlainObject.default)(srcValue) || (0, _isArguments.default)(srcValue)) {
      newValue = objValue;
      if ((0, _isArguments.default)(objValue)) {
        newValue = (0, _toPlainObject.default)(objValue);
      } else
      if (!(0, _isObject.default)(objValue) || (0, _isFunction.default)(objValue)) {
...
baseMergeDeep; /* v9-b4e11d7ef1adfa2c */
