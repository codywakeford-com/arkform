"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _Stack = _interopRequireDefault(require("./_Stack.js"));
...
var _isTypedArray = _interopRequireDefault(require("./isTypedArray.js"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  if (isSameTag && !objIsObj) {
    ...
    return objIsArr || (0, _isTypedArray.default)(object) ?
    (0, _equalArrays.default)(object, other, bitmask, customizer, equalFunc, stack) :
    (0, _equalByTag.default)(object, other, objTag, bitmask, customizer, equalFunc, stack);
  }
...
baseIsEqualDeep; /* v9-9c2794edd31ad119 */
