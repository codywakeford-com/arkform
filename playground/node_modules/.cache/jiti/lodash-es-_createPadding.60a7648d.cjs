"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _baseRepeat = _interopRequireDefault(require("./_baseRepeat.js"));
...
var _stringToArray = _interopRequireDefault(require("./_stringToArray.js"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function createPadding(length, chars) {
  ...
  return (0, _hasUnicode.default)(chars) ?
  (0, _castSlice.default)((0, _stringToArray.default)(result), 0, length).join('') :
  result.slice(0, length);
}var _default = exports.default =

createPadding; /* v9-a1df379d5ad50ab7 */
