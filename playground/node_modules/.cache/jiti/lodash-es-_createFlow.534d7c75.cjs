"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _LodashWrapper = _interopRequireDefault(require("./_LodashWrapper.js"));
...
var _isLaziable = _interopRequireDefault(require("./_isLaziable.js"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function createFlow(fromRight) {
  return (0, _flatRest.default)(function (funcs) {
    ...
    while (++index < length) {
      ...
      if (data && (0, _isLaziable.default)(data[0]) &&
      data[1] == (WRAP_ARY_FLAG | WRAP_CURRY_FLAG | WRAP_PARTIAL_FLAG | WRAP_REARG_FLAG) &&
      !data[4].length && data[9] == 1)
      {
        wrapper = wrapper[(0, _getFuncName.default)(data[0])].apply(wrapper, data[3]);
      } else {
        wrapper = func.length == 1 && (0, _isLaziable.default)(func) ?
        wrapper[funcName]() :
        wrapper.thru(func);
      }
    }
...
createFlow; /* v9-8eb2ba8717df9d17 */
